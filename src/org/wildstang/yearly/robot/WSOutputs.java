...
public enum WSOutputs implements Outputs
{
   ...
   GEAR_HOLD_SOL("Gear Doors",               WSOutputType.SOLENOID_SINGLE, new WsSolenoidConfig(0, 6, false), getLogging()),  // Ctrl 1, Pin  2 Gear Subsystem
   GEAR_TILT_SOL("Gear Tilt",                WSOutputType.SOLENOID_SINGLE, new WsSolenoidConfig(0, 5, false), getLogging()),  // Ctrl 1, Pin  3 Gear Subsystem
   // ********************************
   // Relays
   // ********************************
