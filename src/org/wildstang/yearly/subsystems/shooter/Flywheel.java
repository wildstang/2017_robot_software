...
public class Flywheel extends Shooter
{
   ...
   // Creating a flywheel object so that both wheels can be declared in the Shooter subclass
   ...
   // shooter class to a mutable speed we can change later in our config page. It
...
//
   ...
   // and, more specifically, whether or not its running by returning the toggled
